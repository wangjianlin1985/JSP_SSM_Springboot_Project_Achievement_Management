  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_remark_edit" class="col-md-3 text-right">备注:</label>
		  	 <div class="col-md-9">
			    <textarea id="userInfo_remark_edit" name="userInfo.remark" rows="8" class="form-control" placeholder="请输入备注"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (userInfo, response, status) {
			if (userInfo) {
				...
				$("#userInfo_remark_edit").val(userInfo.remark);
