...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">项目成果网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <!-- 
                 ...
                 <li><a href="<%=basePath %>ProjectType/frontlist">项目类别</a></li>
                  <li><a href="<%=basePath %>DataAuth/frontlist">资料权限</a></li>-->
                <li><a href="<%=basePath %>Teacher/frontlist">老师风采</a></li>
                <li><a href="<%=basePath %>Project/frontlist">项目查询</a></li>
                <li><a href="<%=basePath %>ProAuth/frontlist">项目人员</a></li> 
                <li><a href="<%=basePath %>ProjectData/frontlist">项目资料</a></li>
                <li><a href="<%=basePath %>ProAward/frontlist">项目获奖</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Project/userFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我参与的项目</a></li>
                        <li><a href="<%=basePath %>DataAuth/dataAuth_frontUserAdd.jsp"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;申请查看资料</a></li>
                        <li><a href="<%=basePath %>DataAuth/userFrontlist"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;我申请的权限记录</a></li>
                        <li><a href="<%=basePath %>ProAward/userFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的获奖信息</a></li>
