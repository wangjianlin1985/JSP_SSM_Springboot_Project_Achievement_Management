...
public class TeacherController extends BaseController {
	...
	public void add(@Validated Teacher teacher, BindingResult br,
		...
		try {
			teacher.setTeacherrPhoto(this.handlePhotoUpload(request, "teacherrPhotoFile"));
	...
	public void update(@Validated Teacher teacher, BindingResult br,
		...
		String teacherrPhotoFileName = this.handlePhotoUpload(request, "teacherrPhotoFile");
		if(!teacherrPhotoFileName.equals("upload/NoImage.jpg"))teacher.setTeacherrPhoto(teacherrPhotoFileName); 
	...
	public void OutToExcel(String teacherNo,String name,String birthDate,String telephone, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
        ...
        String[] headers = { "教师工号","姓名","性别","出生日期","教师照片","联系电话"};
        List<String[]> dataset = new ArrayList<String[]>(); 
        for(int i=0;i<teacherList.size();i++) {
        	Teacher teacher = teacherList.get(i); 
        	dataset.add(new String[]{teacher.getTeacherNo(),teacher.getName(),teacher.getGender(),teacher.getBirthDate(),teacher.getTeacherrPhoto(),teacher.getTelephone()});
        }
        /*
