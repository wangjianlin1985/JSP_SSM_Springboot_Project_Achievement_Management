...
public class Teacher {
    ...
    /*教师照片*/
    private String teacherrPhoto;
    public String getTeacherrPhoto() {
        return teacherrPhoto;
    }
    public void setTeacherrPhoto(String teacherrPhoto) {
        this.teacherrPhoto = teacherrPhoto;
    }
    ...
    public JSONObject getJsonObject() throws JSONException {
		...
		jsonTeacher.accumulate("teacherrPhoto", this.getTeacherrPhoto());
