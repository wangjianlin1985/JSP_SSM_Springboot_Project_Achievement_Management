...
public interface ProjectMapper {
	...
	/*用户按照查询条件分页查询项目记录*/
	public ArrayList<Project> userQueryProject(@Param("where") String where,@Param("startIndex") int startIndex,@Param("pageSize") int pageSize) throws Exception;
	...
	/*用户按照查询条件的项目记录数*/
	public int userQueryProjectCount(@Param("where") String where) throws Exception; 
